...
fn register_polynomial_module<'py>(
    ...
    poly_bn254_module.add_function(wrap_pyfunction!(
        bn254::polynomial::get_evaluation_point,
        &poly_bn254_module
    )?)?;
    poly_bn254_module.add_function(wrap_pyfunction!(
        bn254::polynomial::get_all_evaluation_points,
        &poly_bn254_module
    )?)?;
    poly_bn254_module.add_function(wrap_pyfunction!(
    ...
    poly_bls12_381_module.add_function(wrap_pyfunction!(
        bls12_381::polynomial::get_evaluation_point,
        &poly_bls12_381_module
    )?)?;
    poly_bls12_381_module.add_function(wrap_pyfunction!(
        bls12_381::polynomial::get_all_evaluation_points,
        &poly_bls12_381_module
    )?)?;
    poly_bls12_381_module.add_function(wrap_pyfunction!(
...
#[pymodule]
fn _algebra<'py>(_py: Python, m: &Bound<'py, PyModule>) -> PyResult<()> {
